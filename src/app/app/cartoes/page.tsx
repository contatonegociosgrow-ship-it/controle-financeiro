  ...
  return (
    <div className="min-h-screen pb-24 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        {/* Seção Informativa sobre Controle de Cartões */}
        <div className="mb-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div>
              <img 
                src="/credito.webp" 
                alt="Controle completo dos seus cartões de crédito" 
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                  Não precisa mais ficar perdido com múltiplos cartões, faturas e vencimentos. 
                  O <strong className="font-bold text-gray-900 dark:text-white">Meu Salário em Dia</strong> organiza tudo isso para você.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-white text-sm sm:text-base mb-0.5">Controle múltiplos cartões</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Gerencie todos os seus cartões em um só lugar.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-white text-sm sm:text-base mb-0.5">Faturas e vencimentos</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Veja quando cada fatura vence e quanto vai gastar.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-white text-sm sm:text-base mb-0.5">Parcelas automáticas</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Organize parcelas e veja o impacto no orçamento.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-white text-sm sm:text-base mb-0.5">Limites em tempo real</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Acompanhe gastos e limites de cada cartão.</p>
                  </div>
                </div>
              </div>
            </div>
