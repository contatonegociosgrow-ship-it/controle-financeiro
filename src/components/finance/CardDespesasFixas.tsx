...
export function CardDespesasFixas() {
  ...
  const filteredTransactions = useMemo(() => {
    let filtered = state.transactions.filter((t) => t.type === 'expense_fixed');
    ...
    <CardUI className="h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-semibold text-gray-900 tracking-tight">Despesas Fixas</h2>
        </div>
        <div className="flex items-center gap-2">
        ...
        {filteredTransactions.length === 0 ? (
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            ...
            <div className="grid grid-cols-5 py-3 px-4 bg-gray-50 border-b border-gray-200 text-xs font-semibold text-gray-700 uppercase tracking-wider">
              ...
              <div className="font-medium px-3 border-l border-gray-200">Vencimento</div>
